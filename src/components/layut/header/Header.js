...
class Header extends Component {
  ...
  searchText = (e) => {
    const tmpResult = this.state.searchItems.filter((item) =>
  ...
  render() {
    ...
    return (
      <div className="page-wrapper">
        <section
          className={classnames({ overlay: this.state.overlayDisplayed })}
        ></section>
        <header>
          <div className="row py-3 px-cust-5">
            ...
            <div
              id="search-column"
              className="col d-flex align-items-end col-md-6"
            >
                ...
                <ul className="list-unstyled d-block d-none d-lg-block ">
                  {searchItems.map((item) => (
                    <li key={item} className="py-1 px-2">
                      ...
                      <a href={"/brand/" + item} onClick={this.clearSearchbox}>
                        {item}
                      </a>
                    </li>
                  ))}
            ...
            <div className="col-2 d-flex justify-content-between align-items-end align-items-md-end col-md-3">
              {!isLoggedIn && (
                ...
                >
                  <span className="mr-1 font-weight-bold d-none d-md-inline-block">
                    {" "}
                    Login{" "}
                  </span>
              ...
              <div className="collapse navbar-collapse" id="navcol-1">
                <ul className="nav navbar-nav">
                  <li
                    ...
                    onMouseEnter={this.showOverlay.bind(this, true)}
                  ...
                  >
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li>
                        <a href="/blank">Blinds &amp; Window Treatment</a>
                      </li>
                      <li>
                        <a href="/blank">Building Materials</a>
                      </li>
                      <li>
                        <a href="/blank">Decor &amp; Furniture</a>
                      </li>
                      <li>
                        <a href="/blank">
                          <span style={{ textDecoration: "underline" }}>
                      ...
                      <li>
                        <a href="/blank">Flooring &amp; Area Rugs</a>
                      </li>
                      <li>
                        <a href="/blank">Hardware</a>
                      </li>
                      <li>
                        <a href="/blank">Heating &amp; Cooling</a>
                      </li>
                      <li>
                        <a href="/blank">Kitchen &amp; Kitchenware</a>
                      </li>
                      <li>
                        <a href="/blank">Lawn &amp; Garden</a>
                      </li>
                      <li>
                        <a href="/blank">Lighting &amp; Ceiling Fans</a>
                      </li>
                      <li>
                        <a href="/blank">
                          AppliaOutdoor Living &amp; Pationces
                        </a>
                      </li>
                      <li>
                        <a href="/blank">Paint</a>
                      </li>
                    </ul>
                  </li>
        ...
        {Object.keys(errors).length > 0 && (
          <div className="alert alert-danger" role="alert">
            ...
            {errors.password && (
              <span className="d-block">{errors.password}</span>
            )}
          </div>
        )}
            ...
            <div className="modal-content">
              <div className="modal-header">
                ...
                >
                  <span
                    aria-hidden="true"
                    className="c-orange f-2 font-weight-bold"
                  >
                    &times;
                  </span>
                </button>
              ...
              <div className="modal-footer">
                <button
                  type="submit"
                  className="btn btn-primary btn-block font-weight-bold border-inset button"
                  data-dismiss="modal"
...
export default connect(mapStoreToComponent, { signIn, logoutUser })(
  withRouter(Header)
);
