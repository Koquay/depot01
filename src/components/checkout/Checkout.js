...
class Checkout extends Component {
  state = {
    ...
    specialInstruction:
      "Leave package in driveway Leave package in driveway Leave package in driveway Leave package in driveway Leave package in driveway Leave package in driveway ",
  ...
  render() {
    ...
    const checkoutUserData = JSON.parse(
      localStorage.getItem("checkoutUserData")
    );
    console.log("checkout data", checkoutUserData);

    const citiesStatesOptions = citiesStates.map((cityState) => (
      <option
        key={cityState.city}
    ...
    const expMonthOptions = expMonths.map((month) => (
      <option key={month.month} value={month.month}>
        {month.month}
      </option>
    ));

    const expYearOptions = expYears.map((year) => (
    ...
    return (
      <div className="container-fluid bg-eee px-cust-5">
        ...
        <div className="row">
          <div
            className="col-12 bg-white col-md-7 col-xl-8 order-1 order-md-0"
            id="left-col"
          >
              ...
              <div className="row d-none d-md-block">
                <div className="col d-md-flex d-xl-flex align-items-md-center align-items-xl-center">
                  <img
                    alt="blank"
                    className="img-fluid"
                    src="assets/img/LogoMakr_9skTgi.png"
                    style={{ width: "4rem" }}
                  />
                  <span id="page-header" className="ml-1">
                    Secure Checkout
                  </span>
                </div>
              </div>
            ...
            <form>
              <section id="delivery-section">
                <div className="form-row mt-4">
                  <div className="col">
                    <span className="section-header">Delivery</span>
                  </div>
                </div>
                <div className="form-row mt-4">
                    ...
                    <TextField
                      ...
                      value={
                        this.state.firstName
                          ? this.state.firstName
                          : checkoutUserData
                          ? checkoutUserData.firstName
                          : null
                      }
                      onChange={this.onChange}
                      error={
                        orderValidationErrors
                          ? orderValidationErrors.firstName
                          : null
                      }
                    />
                  </div>
                    ...
                    <TextField
                      ...
                      value={
                        this.state.lastName
                          ? this.state.lastName
                          : checkoutUserData
                          ? checkoutUserData.lastName
                          : null
                      }
                      onChange={this.onChange}
                      error={
                        orderValidationErrors
                          ? orderValidationErrors.lastName
                          : null
                      }
                    />
                  </div>
                    ...
                    <TextField
                      ...
                      value={
                        this.state.email
                          ? this.state.email
                          : checkoutUserData
                          ? checkoutUserData.email
                          : null
                      }
                      onChange={this.onChange}
                      error={
                        orderValidationErrors
                          ? orderValidationErrors.email
                          : null
                      }
                    />
                  </div>
                    ...
                    <TextField
                      ...
                      value={
                        this.state.phone
                          ? this.state.phone
                          : checkoutUserData
                          ? checkoutUserData.phone
                          : null
                      }
                      onChange={this.onChange}
                      error={
                        orderValidationErrors
                          ? orderValidationErrors.phone
                          : null
                      }
                    />
                  </div>
                ...
                <div className="form-row mt-4">
                    ...
                    <TextField
                      ...
                      value={
                        this.state.zipCode
                          ? this.state.zipCode
                          : checkoutUserData
                          ? checkoutUserData.zipCode
                          : null
                      }
                      onChange={this.onChange}
                      error={
                        orderValidationErrors
                          ? orderValidationErrors.zipCode
                          : null
                      }
                      minLength="5"
                      maxLength="5"
                  ...
                  <div className="col-12 col-md-6">
                    <SelectList
                      ...
                      error={
                        orderValidationErrors
                          ? orderValidationErrors.cityState
                          : null
                      }
                    />
                  </div>
                ...
                <div className="form-row mt-4">
                  <div className="col-12">
                    <Checkbox
                      ...
                      value={
                        this.state.useAsBillingAddress
                          ? this.state.useAsBillingAddress
                          : checkoutUserData
                          ? checkoutUserData.useAsBillingAddress
                          : null
                      }
                ...
                <div className="form-row mt-4">
                  <div className="col-3 col-lg-2">
                    <img
                      ...
                      src="assets/img/pip-icons-delivery-truck.png"
                    />
                    ...
                    <TextField
                      ...
                      value={
                        this.state.deliveryDate
                          ? this.state.deliveryDate
                          : checkoutUserData
                          ? checkoutUserData.deliveryDate
                          : null
                      }
                      onChange={this.onChange}
                      error={
                        orderValidationErrors
                          ? orderValidationErrors.deliveryDate
                          : null
                      }
                    />
                  </div>
                ...
                <div className="form-row mt-4">
                  <div className="col offset-xl-2">
                    <span>
                      We'll call the business day before with your projected
                    ...
                    <TextArea
                      ...
                      value={
                        this.state.specialInstruction
                          ? this.state.specialInstruction
                          : checkoutUserData
                          ? checkoutUserData.specialInstruction
                          : null
                      }
                ...
                <div className="form-row mt-2">
                  <div className="col">
                    <RadioButton
                      ...
                      checked={
                        this.state.paymentType
                          ...
                          : checkoutUserData
                          ? checkoutUserData.paymentType === "PayPal"
                          : null
                      }
                      onChange={this.onChange}
                    ...
                    <RadioButton
                      ...
                      checked={
                        this.state.paymentType
                          ...
                          : checkoutUserData
                          ? checkoutUserData.paymentType === "CreditCard"
                          : null
                      }
                      onChange={this.onChange}
                      label="Credit Card"
                    ...
                    <InputGroup
                      ...
                      error={
                        orderValidationErrors
                          ? orderValidationErrors.cardNumber
                          : null
                      }
                    />
                  </div>
                ...
                <div className="form-row mt-4">
                  <div className="col">
                    <SelectList
                      ...
                      error={
                        orderValidationErrors
                          ? orderValidationErrors.expMonth
                          : null
                      }
                    />
                  </div>
                  ...
                  <div className="col">
                    <InputGroup
                      ...
                      maxLength="3"
                      error={
                        orderValidationErrors ? orderValidationErrors.cw : null
                      }
                    />
                  </div>
                </div>
